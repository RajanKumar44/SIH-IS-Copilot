...
export const CONCEPTS: Concept[] = [
  ...
  { id: 'led-driver', canonical: 'LED driver (control gear)', forms: { en: ['led driver', 'driver', 'control gear', 'controlgear', 'power supply unit', 'psu', 'ballast'], hi: ['ड्राइवर', 'कंट्रोल गियर'], hinglish: ['driver', 'led driver'] }, sectors: ['lighting'], category: 'product', weight: 2 },
  ...
  { id: 'electrical-safety', canonical: 'electrical safety', forms: { en: ['electric shock', 'electrical safety', 'insulation', 'insulation resistance', 'class i', 'class ii', 'double insulated', 'leakage', 'creepage', 'dielectric', 'safety'], hi: ['सुरक्षा', 'बिजली का झटका', 'इन्सुलेशन', 'विद्युत सुरक्षा'], hinglish: ['safety', 'suraksha', 'jhatka', 'shock', 'insulation'] }, sectors: ['electrical', 'lighting', 'it-electronics'], category: 'safety', weight: 2 },
  { id: 'earthing', canonical: 'earthing', forms: { en: ['earthing', 'earth', 'grounding', 'ground', 'earth electrode', 'earth pit', 'protective earth'], hi: ['अर्थिंग', 'भू-संपर्क', 'ग्राउंडिंग'], hinglish: ['earthing', 'arthing', 'grounding', 'earth pit'] }, sectors: ['electrical'], category: 'installation', weight: 2 },
  ...
  { id: 'cable', canonical: 'electric cable', forms: { en: ['cable', 'cables', 'wire', 'wires', 'conductor', 'core', 'sq mm', 'sqmm', 'armoured', 'armored', 'unarmoured', 'flexible cord', 'frls', 'fr'], hi: ['केबल', 'तार', 'बिजली का तार', 'चालक'], hinglish: ['cable', 'taar', 'tar', 'wire', 'bijli ka taar'] }, sectors: ['cables'], category: 'product', weight: 3 },
  ...
  { id: 'pump', canonical: 'pumpset', forms: { en: ['pump', 'pumps', 'pumpset', 'submersible', 'borewell', 'bore well', 'centrifugal', 'monoblock', 'head', 'discharge', 'lpm', 'lps', 'm3/h'], hi: ['पंप', 'पम्प', 'सबमर्सिबल', 'बोरवेल', 'मोटर पंप'], hinglish: ['pump', 'pamp', 'submersible', 'borewell', 'motor pump'] }, sectors: ['mechanical', 'water'], category: 'product', weight: 3 },
  ...
  { id: 'battery', canonical: 'battery', forms: { en: ['battery', 'batteries', 'lithium', 'li-ion', 'lithium ion', 'lifepo4', 'cell', 'energy storage', 'bess', 'power bank', 'ah'], hi: ['बैटरी', 'लिथियम'], hinglish: ['battery', 'batri', 'lithium'] }, sectors: ['it-electronics', 'renewable'], category: 'product', weight: 3 },
